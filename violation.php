 ...
 if (isset($_POST['submit'])){ 
		 ...
		 $dates = date("Y-m-d");
		 $ins =mysql_query(" INSERT INTO violation_inmate(inmate_id, violation, sanction, dates) VALUES ('$id', '$violation', '$sanction', '$dates') ");
		if ($ins){
			?>
			<script>
			window.location.href = "viewinviolation2.php";</script>
			<?php
		}
	 }
     ...
     <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Inmate Violation</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
					 ...
					 <form action="" method="post" class="form" >
								...
								<tr>
								<td><input type="text" name="violation" class="form-control" placeholder="Enter Inmate Violation" /><br/></td>
								</tr>
								<tr>
								<td><input type="text" name="sanction" class="form-control" placeholder="Sanction" /><br/></td>
								</tr>
