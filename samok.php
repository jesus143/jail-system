...
<?php
 ...
 <form   action = "samok.php" method = "POST"> 
			<div class= "search">
			<label>SEARCH INMATE
		...
		if($_POST['search_customer'] == '') {
			...
			<table class = "table"> 
				...
				?>
						...
						<td > <?php echo "<a href='case.php?inmate_id=$id' >Case Hearing Schedule</a>"; ?> </td>
						<td > <?php echo "<a href='sendsms.php?inmate_id=$id' >SEND SMS</a>"; ?> </td>
		...
		$query = mysql_query("SELECT * FROM inmate") or die("could not search!");
			...
			$count = mysql_num_rows($query);
				...
				?>				
							...
							<td> <?php echo $attorney_name;?></td>
							<td> <?php echo $attorney_contact;?></td>
							<td> <?php echo "<a href='case.php?inmate_id=$id' class = 'edit' >Case Hearing Schedule</a>"; ?> </td>
							<td > <?php echo "<a href='sendsms.php?inmate_id=$id' >SEND SMS</a>"; ?> </td>
