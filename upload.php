...
<body id="page-top" class="index">
    ...
    <header style="background-color: black">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
<form action="rom.php" method="post" enctype="multipart/form-data" class="form-horizontal">
 ...
 <table class="table table-bordered table-responsive">
    ...
    <tr>
	 ...
	 <tr>
     <td><label class="control-label">Middle Initial.</label></td>
        <td><input class="form-control" type="text" name="middleinitial"  /></td>
    </tr>
	 <tr>
		<td><b>Gender</b></td>
