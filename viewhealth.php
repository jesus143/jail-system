    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">View Inmate Health</a>
            </div>
	...
	<header style="background-color: black">
        <div class="container">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM healthinfo JOIN inmate where inmate.inmate_id = healthinfo.inmate_id") 
								or die(mysql_error());  
									
																
								echo "<table class='table' style='color:white'>";
								echo "<tr class='table-active'> <th>Inmate Name</th> <th>Diagnosis</th> <th>Prescription</th><th>Date</th> </tr>";
