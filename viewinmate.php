        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll">
                        <a href="inmate.php">Add INMATE</a>
                    </li>
            ...
            <div class="row">
				<div class="col-lg-12">
          		<div class="intro-text">
                        <span class="name">Inmate Information Section</span>
                        <hr class="star-light">
                        </div>	
...
<?php
 ...
 <form action = "viewinmate.php" method = "POST"> 
			<div class= "search">
			<label>SEARCH INMATE
		...
		if($_POST['search_customer'] == '') {
			...
			<table class = "table"> 
				...
				?>
						...
						<tr><td><b>Inmate Name:</b> <?php echo  $surname. ",". " ". "$firstname". " ". "$middleinitial";?> </td>
						</tr>
						...
						<tr><td><b>Date of Released:</b> <?php echo  $datereleased;?></td>
						</tr>
