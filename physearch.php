...
echo 
		...
		$output .= "Middle Name " . $row['middlename'] . "<br />";
		$output .= "Last Name: " . $row['surname'] . "<br />";
		$output .= "Gender: " . $row['gender'] . "<br />";
		$output .= "Age: " . $row['age'] . "<br />";
		$output .= "Birthday: " . $row['birthday'] . "<br />";
		$output .= "Marital Status: " . $row['marital_status'] . "<br />";
		$output .= "Address: " . $row['address'] . "<br />";
		$output .= "Case Number: " . $row['case_number'] . "<br />";
		$output .= "Case Name " . $row['case_name'] . "<br />";
		$output .= "Date of Imprisonment " . $row['date'] . "<br/><br/><br/><br/>";
		$output .= "</table>";
		$output .= "</center>";
	}
	...
	echo $output;
	 ...
	 echo "<font size='5'>"."Click" . "<a href='search_form.php'>"."  ". "here"  . "</a>"  . "  " . "return"."</font>";
?>
</header>
 <!-- Footer -->
