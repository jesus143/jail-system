        ...
        <div class="container">
					...
					<?php
						...
						$result = mysql_query("SELECT * FROM visitor JOIN inmate where inmate.inmate_id = visitor.inmate_id ") 
								...
								echo "<tr class='table-active'>  <th>Visitor Name</th> <th>Inmate Name</th> <th>Relation</th> <th>Address</th> <th>Contact Number</th><th>Time IN</th> </tr>";
