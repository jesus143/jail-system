        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <img class="img-responsive" src="img/bm.png" height="85" width="85" alt="" >
...
<header style="background-color: black">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-responsive" src="img/men.png" height="200" width="200" alt="">
                    <div class="intro-text">
                        <span class="name">Iligan City Jail Inmate Monitoring System</span>
                        <hr class="star-light">
                        </div>
                </div>
				<div class="col-lg-6">
