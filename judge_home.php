<?php
	...
	$res=mysql_query("SELECT * FROM users WHERE usertype=".$_SESSION['sess_user']);
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="samok.php">Inmate Information </a>
                    </li>
					<li class="page-scroll">
                        <a href="judgecase.php">Case Hearing Schedule</a>
                    </li>
					<li class="page-scroll">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name">Jail Judge Section</span>
